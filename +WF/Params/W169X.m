function P = Parameters()
    ...
    P.folderName = 'WF_W169X\TrialAll\MvtDir0'; % 0 indicate all 8 directions
    ...
    P.select.stimType.whisker = 1; % whisker session

    % animal to be analyses
    P.select.animal.proprioception = {};
    P.select.animal.vibration = {};
    P.select.animal.whisker = {'w1094', 'w1094','w1294'};
