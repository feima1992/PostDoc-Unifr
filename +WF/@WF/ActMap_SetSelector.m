function output = ActMap_SetSelector(obj, inplace, varargin)
    ...
    for i = 1:numel(filedNames)
        ...
        if isfield(obj.ActMap, filedNames{i})
            infoTable = obj.ActMap.(filedNames{i});
            ...
            % set the infoTable
            if inplace
                obj.ActMap.(filedNames{i}) = infoTable;
            end
