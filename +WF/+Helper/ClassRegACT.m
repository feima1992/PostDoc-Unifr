classdef ClassRegACT<handle
    ...
    methods
        % constructor
        function obj = ClassRegACT(varargin)
        ...
        function affineRegister(obj, type)
            ...
            %figure('Color', 'w')
            %imshow(obj.images.IMactREGexp);
            %colormap(fire(2^8));
            %imwrite(uint8(obj.images.IMactREGexp),fullfile(obj.baseFolder, [obj.baseName, '_exp.tif']), 'tif', 'Compression', 'none', 'WriteMode', 'overwrite');
            %imwrite(uint8(obj.images.IMactREG),fullfile(obj.baseFolder, [obj.baseName, '_reg.tif']), 'tif', 'Compression', 'none', 'WriteMode', 'overwrite');
            XYrefCTX = obj.params.XYrefCTX;
            XYref = obj.params.XYref;
            regFile = fullfile(obj.P.dir.regXYs, [obj.baseName '_XYreg.mat']);
            ...
            %exportgraphics(findobj('Name','WF registration'), fullfile(obj.baseFolder, [obj.baseName, '_snapshot.tif']));
            
            %% register all frames of act
            S= load(fullfile(obj.P.dir.ACTmaps, [obj.baseName,'_ACT.mat']));
            ...
            save(fullfile(obj.P.dir.ACTreg, [obj.baseName '_REG.mat']), 'IMcorrREG', 'param', 't', 'imMaskREG');
        end
        ...
        function loadREGcoords(obj)
            ...
            dfname = fullfile(obj.P.dir.regXYs,dfname);
