classdef RegAct < handle
    ...
    methods
        ...
        function affineRegister(obj, type)
            ...
            S = load(fullfile(obj.P.dir.actMap.raw, [obj.baseName, '_ACT.mat']));
            ...
            save(fullfile(obj.P.dir.actMap.reg, [obj.baseName '_REG.mat']), 'IMcorrREG', 'param', 't', 'imMaskREG');
        end
